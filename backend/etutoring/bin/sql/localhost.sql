...
--
-- Host: localhost
-- Generation Time: Feb 29, 2020 at 06:32 AM
...
CREATE TABLE `student` (
  `id` bigint(20) NOT NULL,
  `allocate_id` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `user` (`id`, `password`, `username`, `role_id`, `student_id`, `_id`, `enabled`, `tutor_id`) VALUES
(1, '123', 'admin', 1, NULL, NULL, NULL, NULL),
(2, '123', 'user', 2, NULL, NULL, NULL, NULL);
...
ALTER TABLE `meeting`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK3u4ybshq6w7nx188s82vufhx6` (`record_id`),
  ADD KEY `FKhasp74u8p93hsowv79375kgnu` (`student_id`),
  ADD KEY `FK1c9jq8q7f11nmmksfaauurtmd` (`tutor_id`);
...
ALTER TABLE `student`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FKlyy3iapah3a21wlkwuvieu5ql` (`allocate_id`);
...
ALTER TABLE `tutor`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK3hxd4ttbemrumnm1rptuja2jg` (`allocate_id`);
...
ALTER TABLE `user`
  ...
  ADD KEY `FKbj4tl2by3fqvgmw1y7b6okung` (`_id`),
...
--
ALTER TABLE `meeting`
  ADD CONSTRAINT `FK1c9jq8q7f11nmmksfaauurtmd` FOREIGN KEY (`tutor_id`) REFERENCES `tutor` (`id`),
  ADD CONSTRAINT `FK3u4ybshq6w7nx188s82vufhx6` FOREIGN KEY (`record_id`) REFERENCES `record` (`id`),
  ADD CONSTRAINT `FKhasp74u8p93hsowv79375kgnu` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`);

--
-- Constraints for table `student`
--
ALTER TABLE `student`
  ADD CONSTRAINT `FKlyy3iapah3a21wlkwuvieu5ql` FOREIGN KEY (`allocate_id`) REFERENCES `allocation` (`id`);

--
-- Constraints for table `tutor`
--
ALTER TABLE `tutor`
  ADD CONSTRAINT `FK3hxd4ttbemrumnm1rptuja2jg` FOREIGN KEY (`allocate_id`) REFERENCES `allocation` (`id`);
...
ALTER TABLE `user`
  ...
  ADD CONSTRAINT `FKbj4tl2by3fqvgmw1y7b6okung` FOREIGN KEY (`_id`) REFERENCES `tutor` (`id`),
...
--
ALTER TABLE `user_info`
  ADD CONSTRAINT `FKn8pl63y4abe7n0ls6topbqjh2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"etutoring\",\"table\":\"user\"},{\"db\":\"etutoring\",\"table\":\"user_info\"},{\"db\":\"etutoring\",\"table\":\"role\"}]');
...
('root', '2020-02-29 05:31:23', '{\"Console\\/Mode\":\"collapse\"}');
